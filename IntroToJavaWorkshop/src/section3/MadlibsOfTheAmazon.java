...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
       ...
       JOptionPane.showMessageDialog(null,"Piranhas are more "+adjective+" during the day\n"
		"So cross the river at night."+"Piranhas are attracted to fresh "+liquid+" and will most likely take a bite out of your"
		+bodypart+ "if you" +verb+"if you have an open wound, try to find another way to get to"+place);
